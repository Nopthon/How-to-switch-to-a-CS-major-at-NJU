...
根据某次统计，超过一半的 25 级转专业学生选择同时修读这两门课，然后陆续有人退选了《计算机程序的构造与解释》（课程冲突与课程难度的因素都有）
...
!!! question "我看这里还有一门叫做《问题求解》的课程..."
    ...
    !!! failure "除非你有比较强大的 OI 基础，否则**一定不要选**"
        ...
        《问题求解》对于无基础的大一新生的重量级程度，以及这门课饱受拔尖班 / 匡院学生的诟病。。多的我不说了，《问题求解》是国家级精品课程
...
（唔，似乎只是安慰作用，事实上我更相信 $1/e$ 的玄学划线法）

### <span style="color: #008000;">我现在的专业学习的是二层次数学，需要如何换成一层次数学？</span>

这个<u>你得问你的辅导员</u>，不同的辅导员会给出不同的答案，但是可以肯定的是你直接尝试换课会受到选课系统限制
...
从近两年的结果来看，非 OIer 的比例正在逐步增大，甚至报名的人中 OIer 的比例也有惊人的减少（很奇怪不是吗，大多数考生都是零基础的）

大一一年的时间足够你追赶那些 OIer ：大一下学期认真学习离散数学（也包括通修数学课）可以让你应对笔试，并且对机试的图论题有理论上的帮助；大一上学期掌握 C/C++ 的基本语法，最晚从寒假开始打开 OI-Wiki 规划 OI 学习并努力刷题（洛谷有精选题单），平时有空多打打 Div **3**/4 难度的比赛当作仿真机试，你的机试成绩一定不会差（之前提到过，25 年机试有好几个人的得分低于 100 分，所以不要太神化你的对手，放平心态）
...
### <span style="color: #008000;">我可以在大二开始着手转cs吗</span>

当然可以，不过面临着补专业课的麻烦，以及需要为了笔试复健数学课，为了机试进行训练

### <span style="color: #008000;">我是匡院 / 其他拔尖班 / 计金双学位 / 软件工程 / ... 的学生，我可以转cs吗</span>

要是放在以前我不好说，但是 26 年百花齐放的录取结果提供了理论可行性，不过最好问问教务

### <span style="color: #008000;">我想问的问题在这里没有说明 ｢(ﾟﾍﾟ)　Errrrm…</span>

**在下面的评论区询问（而不是结尾的那个评论区）**，我会即时收到邮箱提醒，并尽量在一天内回答，也可以在转专业交流群直接问（这个群热心群u很多），或者私聊你认识/你不认识但是对方非常热心的老登
