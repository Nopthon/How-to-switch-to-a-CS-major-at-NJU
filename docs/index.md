...
!!! failure "待维护"
    ...
    <span style="font-size:1.1em;">**考虑到今年转cs考试的难度变化较大，以及内容依旧过于混乱，本网站会在暑假重写，所以请不要过度参考本网站的大多数内容**</span>

Welcome to 转cs指北-Online ver!

这里是一个24级的转计算机的老登结合自身转专业经历编写的转cs指北，<del>具有非常强的主观性和一定的片面性</del>
...
!!! success "这个文档最后更新于什么时候？"
    ...
    文档最后更新于 **2026 年 6 月 6 日**，如果这个文档有点旧了，可以在转cs交流群踢我一脚
