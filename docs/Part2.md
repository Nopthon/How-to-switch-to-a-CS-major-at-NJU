...
群论和集合论的题目都需要**扎实的离散数学基础**，而图论的题目通常很难；微积分/线代题通常不难，<del>写不出来心里会很难受</del>

??? example "对于 25 年的笔试题，一些参考如下"
    ...
    你可以在最后一个板块中得到往年的回忆试题

你可能要问笔试的分数线是多少，我只能说能写的尽量写，假装老师会捞人，但是不要写伪证，因为伪证得 0 分
...
!!! warning "压线过机试和满分过机试的结果都是 Accepted，真的没有任何区别。有的时候不需要追求绝对完美"
...
>
> 常用的 C++ STL 库操作（STL 库真的很好用，C 语言没有这些）；一些有关加快 `cin` `cout` 速度的技巧，更进一步的可以尝试掌握快读快写（防止卡常 / 骗部分分）
...
（25 年大一大二机试超过 200 分的有 5 人，供参考；同时还有另一个极端是：机试没有达到 100 分的人，也就是 T1 没写出来的<u>也有很多人</u>，所以不要太神化你的对手）
...
（面试者站在讲台前，三名考官坐在台下；面试教室和对应的三名考官是随机的）
